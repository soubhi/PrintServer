...
<head>
    ...
    <title>
        Different Size Photo Sldier - Jssor Slider
    </title>
    
</head>
<body style="font-family: Arial, sans-serif;">
    <form method="post" action="./different-size-photo-slider.slider" id="form1" class="mainform">
        ...
        <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:600px;height:500px;overflow:hidden;visibility:hidden;">
            ...
            <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:600px;height:500px;overflow:hidden;">
                ...
                <div>
                    <img data-u="image" src="//jssorcdn7.azureedge.net/demos/img/gallery/640x960/001.jpg" />
                </div>
                <div>
                    <img data-u="image" src="//jssorcdn7.azureedge.net/demos/img/gallery/600x240/001.jpg" />
                </div>
                <div>
                    <img data-u="image" src="//jssorcdn7.azureedge.net/demos/img/gallery/200x150/001.jpg" />
                </div>
                <div>
                    <img data-u="image" src="//jssorcdn7.azureedge.net/demos/img/gallery/720x480/005.jpg" />
                </div>
                <div>
                    <img data-u="image" src="//jssorcdn7.azureedge.net/demos/img/gallery/640x960/001.jpg" />
                </div>
                <div>
                    <img data-u="image" src="//jssorcdn7.azureedge.net/demos/img/gallery/980x380/002.jpg" />
                </div>
                <div>
                    <img data-u="image" src="//jssorcdn7.azureedge.net/demos/img/gallery/200x150/001.jpg" />
                </div>
